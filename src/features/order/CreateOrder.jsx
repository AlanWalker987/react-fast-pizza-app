      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            {formErrors?.phone && (
              <p className="mt-2 rounded-md bg-red-100 text-red-700 text-sx p-2">
                {formErrors.phone}
              </p>
            )}
          </div>
        ...
        <div className="mb-12 flex items-center gap-5">
          <input
            ...
            name="priority"
            id="priority"
            className="h-6 w-6 accent-yellow-400 focus:outline-none focus:ring focus:ring-yellow-400 focus:ring-offset-sky-200"
            value={withPriority}
